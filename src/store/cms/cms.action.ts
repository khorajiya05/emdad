...
import { TCmsPageDetail, TCmsPagePayload } from "./cms.types";
 ...
 * @returns
 */
const getCmsPageSuccess = (payload: TCmsPagePayload) => action(CmsActionTypeEnum.GET_CMS_SUCCESS, payload);
 ...
 * @returns
 */
const updateCmsPagesSuccess = (payload: TCmsPagePayload, pageId: string | number) => action(CmsActionTypeEnum.UPDATE_CMS_SUCCESS, { payload, pageId });

/**
 * Update cms page pending action creator
 * @returns
 */
const updateCmsPagesPending = () => action(CmsActionTypeEnum.UPDATE_CMS_PENDING);
 ...
 * @returns
 */
const getSingleCmsPageSuccess = (payload: TCmsPageDetail) => action(CmsActionTypeEnum.GET_SINGLE_CMS_SUCCESS, payload);

/**
 * Get single cms page failed action creator
 * @returns
 */
const getSingleCmsPageFailed = () => action(CmsActionTypeEnum.GET_SINGLE_CMS_FAILED);

/**
 * Get single cms page pending action creator
 * @returns
 */
const getSingleCmsPagePending = () => action(CmsActionTypeEnum.GET_SINGLE_CMS_PENDING);
