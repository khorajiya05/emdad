...
const FuelForm: React.FC = () => {
    ...
    const handleRedirectToFuelForm = () => {
        navigate("/fuel/list");
    };
                        ...
                        <header className="page-header">
                            <div className="d-flex align-items-center">
                                ...
                                <div className="m-l-10">
                                    <button className="btn btn-secondary" onClick={handleRedirectToFuelForm}>
                            ...
                            <div className="card">
                                <form className="form-horizontal">
                                    ...
                                    <div className="card-footer bg-light text-right">
                                        <button type="button" className="btn btn-secondary clear-form mr-2" onClick={handleRedirectToFuelForm}>Cancel</button>
                                        <button type="button" className="btn btn-primary" onClick={handleRedirectToFuelForm}>Submit</button>
                                    </div>
                                </form>
                            </div>
                        </section>
