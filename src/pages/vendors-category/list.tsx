...
const VendorsCategoryList: React.FC = () => {
  // constructor() {
  //     super();
  //     state = {
  //         show: false,
      ...
      <Modal centered scrollable show={show} onHide={() => handleClose()}>
        ...
        <Modal.Body>
          ...
          <div className="form-group">
            ...
            <div className="mt-1">
              <label className="control control-outline d-inline-block control-primary control--radio mb-0 mr-3">
                {" "}
                Active
                <input
                  type="radio"
              ...
              <label className="control control-outline d-inline-block control-primary control--radio mb-0">
                {" "}
                Inactive
                <input
                  type="radio"
          ...
          {/* <div className="form-group">
            <label className="control-label">Assign to driver</label>
            <Select
              className="custom-select-dropdown"
              value={
                selectedValue2
...
export default VendorsCategoryList;
